...
try 
{
    ...
    // CORRECTION : Ajout du convertisseur de chaîne pour les Enums
    ...
    if (app.Environment.IsDevelopment())
    {
        using (var scope = app.Services.CreateScope())
        {
            ...
            try { mapper.ConfigurationProvider.AssertConfigurationIsValid(); }
            catch (Exception ex) { Console.WriteLine($"AUTO-MAPPER VALIDATION FAILED: {ex.Message}"); }
        }
        app.UseSwagger();
        app.UseSwaggerUI();
    }
